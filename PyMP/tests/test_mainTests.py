...
#        ext = ".png"
        ...
        approximant = mp.mp(
            signal_one_atom, pyRandomDico, 10, 10, False, False)[0]
#        approximant.plot_tf()
#        plt.subplot(211)
        plt.plot(signal_one_atom.data)
        plt.plot(approximant.recomposed_signal.data)
...
#        plt.show()
        ...
        approximant, decay = mp.mp(
            signal_one_atom, pyRandomDico, 10, 10, False, False)
#        approximant.plot_tf()
        plt.subplot(212)
        plt.plot(signal_one_atom.data)
        plt.plot(approximant.recomposed_signal.data)
...
#        pyCCDico =
        approximant = mp.mp(
            signal_original, pyRandomDico, 10, 10, False, False)[0]
#        approximant.plot_tf()
        plt.subplot(212)
        plt.plot(signal_original.data[4096:-4096])
        plt.plot(approximant.recomposed_signal.data[4096:-4096])
...
#        plt.show()
        ...
        t2 = time.clock()
        approx2 = mp.mp(signal_original, pyRandomDico, 20, 500, False, False)[0]
        t3 = time.clock()
        plt.subplot(212)
        plt.plot(signal_original.data[12288:-12288])
        plt.plot(approx2.recomposed_signal.data[12288:-12288])
...
#        plt.show()
        ...
        t2 = time.clock()
        approx2 = mp.mp(noise_signal, pyRandomDico, 10, 500, False, True)[0]
        t3 = time.clock()
        plt.subplot(212)
        plt.plot(noise_signal.data[16384:-16384])
        plt.plot(approx2.recomposed_signal.data[16384:-16384])
